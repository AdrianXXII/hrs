<form action="{{ route('test') }}" class="form-horizontal" method="POST">
    {{ csrf_field() }}
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <label for="region" class="col-md-12 right control-label label-left">Region</label>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="input-group date" id="datepicker_anreise">
                        <input id="anreisedatum" type="text" class="form-control" name="anreisedatum" />
                ...
                <div class="col-md-12">
                    <div class="input-group date" id="datepicker_abreise">
                        <input id="abreisedatum" type="text" class="form-control" name="abreiseatum" />
                        <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                    </div>
