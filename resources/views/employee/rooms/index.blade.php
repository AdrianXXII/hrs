                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                @if($rooms === null)
                                        ...
                                        <a href="{{ route('employee.hotels.index') }}" class="btn btn-default">
                                            <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Abbrechen
                                        </a>
                                @else
                                    <div class="float-right">
                                        <a href="{{ route('employee.rooms.create', ['hotel' => $hotel->id]) }}" class="btn btn-primary">
                                        ...
                                        <tbody>
                                            @foreach($rooms as $room)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('employee.rooms.edit', ['hotel' => $hotel->id, 'room' => $room->id]) }}" class="btn btn-primary">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                                        </a>
                                                        <form class="deleteBtn" method="post" action="{{ route('employee.rooms.delete', ['hotel' => $hotel->id, 'room' => $room->id]) }}">
                                                            {{ csrf_field() }}
