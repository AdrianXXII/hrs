                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12 col-sm-10">
                                <form action="{{ route('backend.categories.save') }}" class="form-horizontal" method="POST">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group{{ $errors->has('number_of_beds') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="number_of_beds" type="number" min="1" class="form-control" name="number_of_beds" value="{{ old('number_of_beds') }}">
