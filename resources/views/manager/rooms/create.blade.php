                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12 col-sm-10">
                                <form action="{{ route('manager.rooms.save', ['hotel' => $hotel->id]) }}" class="form-horizontal" method="POST">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <select id="room_type" name="room_type" class="form-control">
                                                @foreach($roomTypes as $roomType)
                                                    <option value="{{ $roomType->id }}">{{ $roomType->getData() }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-4">
                                            ...
                                            <a href="{{ route('manager.rooms.index', ['hotel' => $hotel->id]) }}" class="btn btn-default">
